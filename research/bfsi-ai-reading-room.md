---
tags: [research, reading-room, tcs, bfsi, ai, banking, insurance, capital-markets, risk]
updated: 2026-09-09
---
...
```mermaid
mindmap
  root((TCS BFSI AI public research))
    Enterprise AI
      End of AI pilots
      AI investment ROI
      AI lifecycle + AI-CoE
...
```mermaid
flowchart LR
  A[GenAI in Finance] --> B[Context Fabric] --> C[CAP] --> D[AI Spectrum] --> E[AI Compass] --> F[ABOS]
```
...
```mermaid
flowchart LR
  A[Responsible AI Blueprint] --> B[AI Reliability] --> C[RiskTech / Chartis] --> D[Context Fabric] --> E[CAP controls]
```
...
```mermaid
flowchart LR
  A[TCS BaNCS] --> B[AI Compass] --> C[Agentic human-centric engagement] --> D[ABOS] --> E[Quartz / market infrastructure]
```
